...
const TimelineItem = (items: any) => {
    ...
    return items.map((item: any, index: number) => <Timeline.Item data-aos="fade-up" data-aos-duration="800"
        ...
        <div className="border shadow-[0_0_10px_0_#4cbbd4] hover:-translate-y-2 transition transform duration-300 ease-in-out flex flex-col gap-2 border-primaryColor p-4 rounded-2xl sm-mx:p-2">
...
const Experience = () => {
    ...
    return <div className="px-16 mx-20 md-mx:px-6 sm-mx:px-2 lg-mx:mx-0 my-10 mb-28 font-mono" id="Experience">
        ...
        <Timeline color="#4cbbd4" active={5} bulletSize={dot} lineWidth={2}>
            {
